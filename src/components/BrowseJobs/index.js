...
const BrowseJob = () => (
  <header className="page-header bg-img" style={{ backgroundImage: 'url(/img/bg-banner1.jpg)' }}>
        ...
        <div className="row">
            ...
            <div className="checkall-group">
              <div className="checkbox">
                <label htmlFor="contract1">
                  <input type="checkbox" id="contract1" name="contract" defaultChecked />
                  All types
                </label>
              </div>
          ...
          <div className="form-group col-xs-12 col-sm-4">
            ...
            <div className="checkall-group">
              <div className="checkbox">
                <label htmlFor="rate1">
                  <input type="checkbox" id="rate1" name="rate" defaultChecked />
                  All rates
                </label>
              </div>
            ...
            <div className="checkall-group">
              <div className="checkbox">
                <label htmlFor="degree1">
                  <input type="checkbox" id="degree1" name="degree" defaultChecked />
                  All degrees
                </label>
              </div>
